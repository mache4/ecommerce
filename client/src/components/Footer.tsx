    ...
    return (
        <div className="flex w-full py-10 px-32 border-t border-t-light-grey">
            ...
            <div className="w-1/4">
                ...
                <p className="text-dark-grey mt-2">branislavrendulic@gmail.com</p>
                <p className="text-dark-grey mt-2">Github</p>
            </div>
            <div className="w-1/4">
                <h1 className="text-lg">About</h1>
                <p className="text-dark-grey mt-2 leading-7">This app's client side is based on React. It is full functional store with Strapi as contact management system and Stripe for payment processing. TailwindCSS is used for styling.</p>
            </div>
        </div>
    );
}
